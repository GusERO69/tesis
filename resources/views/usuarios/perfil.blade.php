        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">{{ __('Profile') }}</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                                ...
                                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                                            ...
                                            <span
                                                class="svg-icon svg-icon-4 me-1 d-flex align-items-center text-gray-400 text-hover-primary mb-2">
                                                {{ $user->email }}
                                            </span>
                                        </div>
                                    </div>
                        ...
                        <form id="kt_account_profile_details_form" class="form" method="POST"
                            ...
                            <div class="card-body border-top p-9">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true"
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px"
                                                style="background-image: url(/imagen/{{ $user->image }})"></div>
                                            <label
                                        ...
                                        <!--end::Image input-->
                                        <!--begin::Hint-->
                                        <div class="form-text">{{ __('Only files types: png, jpg, jpeg.') }}</div>
                                        <!--end::Hint-->
                                    </div>
                                    <!--end::Col-->
                                </div>
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label
                                        class="col-lg-4 col-form-label fw-bold fs-6">{{ __('Names and Lastnames') }}</label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8">
                                        <!--begin::Row-->
                                ...
                                <div class="row mb-6" data-kt-password-meter="true">
                                    {{-- <div class="mb-1"> --}}
                                    <label class="col-lg-4 col-form-label fs-6">{{ __('Password') }}</label>
                                    <div class="col-lg-8 fv-row position-relative">
                                        ...
                                        <span
                                            ...
                                            data-kt-password-meter-control="visibility"><i
                                                class="bi bi-eye-slash fs-2"></i><i
                                                class="bi bi-eye fs-2 d-none"></i></span>
                                    </div>
                                    {{-- </div> --}}
                                </div>
                            </div>

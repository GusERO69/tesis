            ...
            l = function (e) {
                e.preventDefault(),
                    !1 !==
                        ...
                        if (n.inputElement.files.length === 0) {
                            // El campo input de tipo file está vacío después de la cancelación
                            console.log('Campo input=file está limpio después de la cancelación');
                        }
            },
            s = function (e) {
                e.preventDefault(),
                    !1 !==
                        ...
                        if (n.inputElement.files.length === 0) {
                            // El campo input de tipo file está vacío después de la remoción
                            console.log('Campo input=file está limpio después de la remoción');
                        }
